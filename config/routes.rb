ActionController::Routing::Routes.draw do |map|
  ...
  map.by_sector 'browse/sector/:sector_id/country/:country_id', :controller => 'browse', :action => 'by_sector'
  map.narrow_sector_by_country 'browse/sector/:sector_id/country', :controller => 'browse', :action => 'narrow_sector_by_country'
  #map.sector_by_country 'browse/sector/:sector_id/country/:country_id', :controller => 'browse', :action => 'sector_by_country'
